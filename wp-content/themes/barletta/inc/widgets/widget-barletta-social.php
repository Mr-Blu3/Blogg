...
class barletta_social_widget extends WP_Widget
{
	...
	*/
	function update( $new_instance, $old_instance ) {
		...
		$instance['linkedin'] = ( ! empty( $new_instance['linkedin'] ) ) ? esc_html( $new_instance['linkedin'] ) : '';
		return $instance;
	...
	$defaults = array( 'title' => 'Follow Me', 'rss' => '', 'facebook' => '', 'twitter' => '', 
						...
						'soundcloud' => '', 'dribbble' => '', 'youtube' => '', 'flickr' => '', 'linkedin' => '');
	...
	<!-- Linkein URL -->
	<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'linkedin' )); ?>"><?php _e('URL address of your LinkedIn','barletta') ?>:</label>
		<input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'linkedin' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'linkedin' )); ?>" type="text" value="<?php echo esc_attr($instance['linkedin']); ?>" style="width:90%;" />
	</p>
