	...
	<nav class="navigation post-navigation" role="navigation">
		...
		<div class="nav-links">
			...
			if ( is_attachment() ) :
				...
				previous_post_link( '%link', __( '<div class="meta-nav meta-nav-left"><span>Previous Post</span></div>', 'barletta' ) );
				next_post_link( '%link', __( '<div class="meta-nav meta-nav-right"><span>Next Post</span></div>', 'barletta' ) );
			endif;
			?>
		</div><!-- .nav-links -->
	</nav><!-- .navigation -->
